...
{
    /// <summary>
    /// Thread-safe in-memory store for the most recent Zigbee sensor readings.
    /// Updated by <see cref="ZigbeeMqttService"/> and read by <see cref="PlantSense.Helpers.SensorManager"/>.
    /// </summary>
    public static class ZigbeeSensorCache
    {
